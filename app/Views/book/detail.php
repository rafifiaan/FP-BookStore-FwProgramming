...
<body>
  ...
  <main class="min-h-screen w-10/12 mx-auto py-32">
    ...
    <section class="mt-6 flex flex-col lg:flex-row gap-12">
      ...
      <div class="space-y-7 lg:w-1/2">
        <div class="space-y-1">
          ...
          <div class="flex mb-3 items-center justify-between">
            ...
            <p class="line-clamp-2 font-medium text-sm text-blue-500 bg-blue-100/50 py-1 px-3 w-fit rounded-lg"><?= $book['genre'] ?></p>
          </div>
          
          
          <p class="text-orange-500 font-semibold text-2xl">Rp <?= number_format($book['price']) ?></p>
        </div>
        <div class="">
      ...
      <div class="bg-white rounded-xl border p-6 grow h-fit space-y-2.5 min-w-[15rem]">
        <p class="font-medium text-lg pb-2">Check Out</p>
        
        
        <!-- <p class="text-sm">Stok :</p> -->
        <div class="flex items-center justify-between pb-2">
          <div class="flex items-center gap-6">
            <button id="decrement-btn" type="button" class="p-1.5 rounded-sm bg-slate-100 hover:bg-slate-200 w-6 h-6 flex items-center justify-center">
              -
            </button>
            <p id="quantity-display">1</p>
            <button id="increment-btn" type="button" class="p-1.5 rounded-sm bg-slate-100 hover:bg-slate-200 w-6 h-6 flex items-center justify-center">
              ﹢
            </button>
        ...
        <div class="flex items-center justify-between text-sm">
          ...
          <p id='subtotal-price' class="font-semibold text-lg text-orange-500">Rp <?= number_format($book['price']) ?></p>
        </div>
        ...
        <form action="<?= route_to('transaction.prepare') ?>" method="POST">
          ...
          <button type="submit" class="rounded-lg bg-blue-500 hover:bg-blue-700 text-white w-full min-h-[2.25rem] md:min-h-[2.5rem] flex items-center justify-center text-sm mt-4">Beli Sekarang</button>
        </form>
      </div>
    </section>
  </main>
